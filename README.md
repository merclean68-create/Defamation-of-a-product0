...
<header>
  <div style="display:flex;flex-direction:column;align-items:center;gap:20px;">
    ...
    <img src="https://ar.wikipedia.org/wiki/%D9%85%D9%84%D9%81:Mercedes-Logo.svg" alt="Mercedes-Benz" class="logo-animate" style="max-width:120px; filter: brightness(0) invert(1);" />
...
<section class="tutorial-box">
  ...
  <iframe class="video-interactive" src="https://www.youtube.com/shorts/Y57GhIiFlYk" title="شرح الفيديو التعليمي" allowfullscreen></iframe>
  <p data-ar="هذا الفيديو يوضح كيفية التحكم في جدب زبون data-en="This video shows how to manage your site and add your own code" data-fr="Cette vidéo montre comment gérer votre site et ajouter votre propre code"></p>
</section>
...
<section class="interactive-box">
  ...
  <p data-ar="تعلم فن التشهير جرب المتعة" data-en="You can edit the text, click the button, or change the animated image to try controlling it yourself" data-fr="Vous pouvez modifier le texte, cliquer sur le bouton ou changer l'image animée pour tester vous-même"></p>
